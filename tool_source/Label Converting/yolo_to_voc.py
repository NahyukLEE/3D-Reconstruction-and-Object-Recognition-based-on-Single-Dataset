...
IMG_PATH = r'C:/Users/CGlab/Desktop/test/img/'
fw = os.listdir(IMG_PATH) 
# path of save xml file 
save_path = r'C:/Users/CGlab/Desktop/test/label/' 

# txt_folder is txt file root that using darknet rectbox 
txt_folder = r'C:/Users/CGlab/Desktop/test/label_old/'

# edit ypur label set 
labels = ['refrigerator', 'cooker'] 
